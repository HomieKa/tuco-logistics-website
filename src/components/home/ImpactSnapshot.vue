    ...
    <section class="bg-[#0c233f] py-20 text-white">
      <div class="container mx-auto px-4">
        <div class="grid gap-10 lg:grid-cols-[1.1fr_1fr]">
          <div class="space-y-4">
            <p class="text-sm font-semibold uppercase tracking-[0.35em] text-sky-300">Impact snapshot</p>
          ...
          <p class="text-base text-slate-100/90">
            TUCO blends deep carrier relationships with the Freightmate control tower, delivering measurable outcomes across
            every shipment, site, and stakeholder you manage.
          </p>
        </div>
        ...
        <div class="mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            <div class="pl-6">
              <p class="text-4xl font-semibold tracking-tight text-white">{{ metric.value }}</p>
              <p class="mt-2 text-sm font-semibold uppercase tracking-[0.2em] text-sky-200">
                {{ metric.label }}
              </p>
